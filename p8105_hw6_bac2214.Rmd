...
I staretd this question off by importing the dataset and making factors for the categorical variables! 
```{r}
...
# Model diagnostics: plot of residuals against fitted values
