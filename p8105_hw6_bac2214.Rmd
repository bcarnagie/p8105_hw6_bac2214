...
The Bootstrap Distribution of R-squared is slightly right-skewed while the Bootstrap Distribution of log(beta1 * beta2) is skewed right significantly. The CI for r_squared is `r sprintf("%.2f", r_squared_ci[1])` to `r sprintf("%.2f", r_squared_ci[2])`, and the CI for log(beta1 * beta2) is `r sprintf("%.2f", log_beta_product_ci[1])` to `r sprintf("%.2f", log_beta_product_ci[2])`.
